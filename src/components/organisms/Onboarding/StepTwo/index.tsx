...
const challengesOptions: OptionType[] = [
  ...
  {
    value: 'Diferencias en crianza de hijos',
    label: 'Diferencias en crianza de hijos',
  },
  {
    value: 'Carga mental / tareas del hogar',
    label: 'Carga mental / tareas del hogar',
  },
...
const expectationsOptions: OptionType[] = [
  {
    value: 'Sentirme escuchado/a y comprendido/a',
    label: 'Sentirme escuchado/a y comprendido/a',
  },
  {
    value: 'Consejos para comunicarme mejor',
    label: 'Consejos para comunicarme mejor',
  },
  {
    value: 'Ver las cosas desde la perspectiva de mi pareja',
    label: 'Ver las cosas desde la perspectiva de mi pareja',
  },
...
export const StepTwo = () => {
  ...
  const selectedChallenges = Array.isArray(challengesValue)
    ? challengesValue
        .map((val) => challengesOptions.find((o) => o.value === val))
        .filter(Boolean)
    : []

  const selectedExpectations = Array.isArray(expectationsValue)
    ? expectationsValue
        .map((val) => expectationsOptions.find((o) => o.value === val))
        .filter(Boolean)
    : []
